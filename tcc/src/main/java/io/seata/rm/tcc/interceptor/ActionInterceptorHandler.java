...
public class ActionInterceptorHandler {
     ...
     *
     * @param method    the method -- THE TCC try/confirm/cancel-method
     * @param arguments the arguments of the TCC-method, 实参
     * @return map map
     */
    protected Map<String, Object> fetchActionRequestContext(Method method, Object[] arguments) {
        Map<String, Object> context = new HashMap<>(8);

        // 获取方法上的注解: 一个参数可能会有多个注解, 所以此处是二维数组
        // index-i 是一个数组, 表示第 i 个参数上标注的注解的数组形式
